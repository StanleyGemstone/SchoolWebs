...
// import useAuth from "../components/useAuth";
// import { useReactToPrint } from "react-to-print";
// import "../styles/ReportSheet.scss"; // Ensure this includes overflow styling
...
//   if (loading) return <div>Loading...</div>;
//   if (error) return <div>Error: {error}</div>;
//   if (!teacherSection) return <div>Loading teacher info...</div>;
...
//       <div className="table-scroll-wrapper" ref={componentRef}>
//         <div className="header">
//           <h1>ROYAL HERITAGE GROUP OF SCHOOLS REPORT BROAD SHEET</h1>
//           <h2>SENIOR SECONDARY SCHOOL</h2>
//         </div>
...
//                 <th rowSpan="2">NAMES</th>
//                 {currentStudents.map((student) => (
//                   <th key={student.id} colSpan="7">
//                     {`${student.surname} ${student.firstName} ${student.middleName}`.toUpperCase()}
//                   </th>
//                 ))}
//               </tr>
//               <tr>
//                 {currentStudents.map(() =>
//                   subjectsBySection[teacherSection].map((subject, idx) => (
//                     <React.Fragment key={`${subject}-${idx}`}>
//                       <th>CAT1</th>
//                       <th>CAT2</th>
//                       <th>ASGT</th>
//                       <th>EXAM</th>
